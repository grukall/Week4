...
void FGraphicsManager::Render()
{
	...
	for (const FRenderInfo& renderInfo : mRenderCollector.RenderInfos)
	{
		...
		if (renderInfo.Material)
		{
			...
			mMeshPipeline->SetSamplerState(1, D3D11_FILTER_MIN_MAG_MIP_LINEAR, D3D11_TEXTURE_ADDRESS_WRAP, D3D11_TEXTURE_ADDRESS_WRAP);
			mMeshPipeline->SetSamplerState(2, D3D11_FILTER_MIN_MAG_MIP_LINEAR, D3D11_TEXTURE_ADDRESS_WRAP, D3D11_TEXTURE_ADDRESS_WRAP);
			mMeshPipeline->SetSamplerState(3, D3D11_FILTER_MIN_MAG_MIP_LINEAR, D3D11_TEXTURE_ADDRESS_WRAP, D3D11_TEXTURE_ADDRESS_WRAP);
